 ...
 // Constructor
    ...
    public void cargarArchivosCSV(String[] archivosCSV) {
        ...
        for (Carpeta carpeta : carpetas) {
            carpeta.setRecursos((Map<String, Recurso>) recursos);
        }
    ...
    public void iniciar() throws excepcionContrasena, excepcionArchivoInvalido, excepcionCursoCompleto, excepcionDuplicacionRecurso, excepcionAccesoNoAutorizado, excepcionFormatoString {
    ...
    private Usuario ingresarDatosUsuario() throws excepcionFormatoString {
        ...
        if (!rut.matches("^[0-9]{7,8}-[0-9Kk]$")) {
            throw new excepcionFormatoString("El RUT ingresado no tiene un formato válido.");
        }
    ...
    private void cambiarContraseña() throws excepcionContrasena{
        while (true) {
            ...
            if (contraseñaActual == null) {
                ...
                if (!contraseñaIngresada.equals(contraseñaActual)) {
                    throw new excepcionContrasena("La contraseña ingresada no es correcta.");
                    }
                if (contraseñaIngresada.equals(contraseñaActual)) {
    ...
    private void revisarCursos() throws excepcionDuplicacionRecurso {
    ...
    private void editarCurso() throws excepcionCursoCompleto, excepcionDuplicacionRecurso, excepcionArchivoInvalido, excepcionAccesoNoAutorizado {
        if (!(usuarioActual instanceof Profesor)) {
            throw new excepcionAccesoNoAutorizado("No tiene permisos para editar cursos.");
        }
    ...
    public void mostrarSubmenuCurso(Curso curso) throws excepcionDuplicacionRecurso {
        int opcion;
    ...
    public void mostrarSubmenuCarpetas(Curso curso) throws excepcionDuplicacionRecurso{
   ...
   private void configurarUsuario() throws excepcionContrasena {
    System.out.println("\n--- Configuración ---");
