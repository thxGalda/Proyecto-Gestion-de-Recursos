...
public class Curso {
    ...
    // Constructor 3.5: Sin lista inicial de estudiantes ni id. Se agrega Número de estudiantes
    ...
    public void cargarRecurso(String nombreCarpeta, Recurso recurso) throws excepcionDuplicacionRecurso, excepcionArchivoInvalido {
        if (!recurso.getFormato().equals("PDF") && !recurso.getFormato().equals("DOCX")) {
            throw new excepcionArchivoInvalido("El archivo subido no tiene un formato válido.");
        }
    ...
    public void cargarRecurso(String nombreCarpeta, List<Recurso> recursos) throws excepcionDuplicacionRecurso {
    ...
    public void cargarRecurso(int idCarpeta, Recurso recurso) throws excepcionDuplicacionRecurso {
        if (recurso == null) {
    ...
    public void cargarRecurso(int idCarpeta, List<Recurso> recursos) throws excepcionDuplicacionRecurso {
    ...
    public void agregarEstudiante(Estudiante estudiante) throws excepcionCursoCompleto {
