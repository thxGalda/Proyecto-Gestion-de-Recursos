...
public class Main {
	public static void main(String[] args) throws excepcionInicializacionFallida, excepcionContrasena{
    ...
    public static void inicializarCursos(Menu menu) throws excepcionInicializacionFallida {
        try {
        ...
        // Crear los cursos
        Curso cursoMatematica = new Curso("Matemática 1",1, "Curso de matemáticas avanzadas", profesorMatematica);
        Curso cursoFisica = new Curso("Física 2",1, "Curso de física moderna", profesorFisica);
        Curso cursoProgramacion = new Curso("Programación Avanzada",1, "Curso avanzado de programación en Java", profesorProgramacion);
        ...
        menu.agregarCurso(cursoProgramacion);
            ...
            throw new excepcionInicializacionFallida("Error al inicializar los cursos.");
        }
